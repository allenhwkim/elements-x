...
// for debugging, e.g xon-click="log('my log indicator')"
export function log(scope, target, options) { 
  console.log('> x-div log', target, options);
}


// xon-click="add(todos, name=::value, id=::id, done=false)"
...
export function goto(scope, target, params) { 
  ...
  if (mainRoute) { // xon-click="goto(/show/1), xon-success="goto(/list)"
