...
import {setCustomElementHTMLCss, setTargetValue} from '../common/util';
...
class XClock extends HTMLElement {
  ...
  _init() {
    ...
    this.addEventListener('touchstart', this._onDragStart.bind(this));
    this.addEventListener('mousemove', this._onDragFunc.bind(this));
    this.addEventListener('touchmove', this._onDragFunc.bind(this));
  ...
  _updateHourHand(_time, updateMin=true) {
    ...
    setTargetValue(this, this._time);
  }
