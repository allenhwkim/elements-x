...
import defaultMarker from './marker.svg.html';
...
export class XOLMarker extends HTMLElement {
  ...
  setMarker(position) {
    ...
    return getLonLat(position).then(lonLat => {
      ...
      console.log('................', {position, map: this.map});
      console.log('................', {marker: this.marker, lonLat, image: this.image});
      setTimeout(_ => {
