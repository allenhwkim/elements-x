...
export class XList extends HTMLElement {
  constructor(...args) {
    ...
    this._evtName = 'x-listitem-selected';
    this.rarget;
    return self;
  }
  ...
  _fireSelect(el) {
    ...
    if (el && (el.offsetParent !== null)) { // if visible
      ...
      this.dispatchEvent(new CustomEvent(this._evtName, { bubbles: true, detail: el }));
      setTargetValue(this.target, el.getAttribute('value') || el.innerText);
    }
  }
